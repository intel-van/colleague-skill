...
[![Stars](https://img.shields.io/github/stars/intel-van/colleague-skill?style=social)](https://github.com/intel-van/colleague-skill/stargazers)
...
[🆕 更新](#-这次大版本更新了什么) · [📦 数据来源](#-支持的数据来源) · [⚡ 安装](#-安装) · [🚀 使用](#-使用) · [✨ 效果示例](#-效果示例) · [📖 深度阅读](#-深度阅读) · [💬 Discord](https://discord.gg/NVX66RxWZv)

[**English**](docs/lang/README_EN.md) · [**Español**](docs/lang/README_ES.md) · [**Deutsch**](docs/lang/README_DE.md) · [**日本語**](docs/lang/README_JA.md) · [**Русский**](docs/lang/README_RU.md) · [**Português**](docs/lang/README_PT.md) · [**한국어**](docs/lang/README_KO.md)
...
>
> <img src="docs/assets/wechat-group-qr-12.png" alt="dot-skill 微信群二维码" width="240">
>
...
<td><sub>🆕 <b>生活照片分享功能即将上线</b> —— 让你蒸馏出的关系不只是回消息，还能像真人一样发照片、分享生活片段。</sub></td>
...
> 飞书/钉钉自动采集凭证、把生成的角色 Skill 一键安装到宿主、Windows 特殊处理等，见 **[详细安装说明](INSTALL.md)**
...
│   ├── relationship/               #   [relationship] 专属 prompt
│   └── celebrity/                  #   [celebrity] 专属 prompt
├── tools/                          # Python 工具
...
├── docs/                           # 设计文档与深度分析
│   ├── PRD.md                      #   产品需求文档
│   ├── DEEP_ANALYSIS.md            #   深度架构分析
│   ├── SKILL_TYPE_ABSTRACTION_DESIGN.md      # 类型抽象设计
│   ├── SKILL_TYPE_ABSTRACTION_DESIGN_ZH.md   # 类型抽象设计（中文）
│   ├── lang/                       #   多语言 README
│   └── assets/                     #   图片资源
...
除本 README 外，`docs/` 目录下还有以下文档供深入了解：

| 文档 | 说明 |
|------|------|
| [📋 产品需求文档（PRD）](docs/PRD.md) | v2.0 完整产品需求，含输入规范、生成规范、进化机制 |
| [🏗️ 类型抽象设计](docs/SKILL_TYPE_ABSTRACTION_DESIGN_ZH.md) | 从 colleague 到 dot-skill 的架构演进方案（中文） |
| [🏗️ Type Abstraction Design](docs/SKILL_TYPE_ABSTRACTION_DESIGN.md) | 同上，英文版 |
| [🔬 深度架构分析](docs/DEEP_ANALYSIS.md) | 管线架构、分层设计、质量关卡、可迁移经验 |
| [🗺️ 路线图](ROADMAP.md) | 项目演进规划 |
...
<a href="https://www.star-history.com/?repos=intel-van%2Fcolleague-skill&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=intel-van/colleague-skill&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=intel-van/colleague-skill&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=intel-van/colleague-skill&type=date&legend=top-left" />
 </picture>
</a>
...
**MIT License** © [titanwings](https://github.com/titanwings) · Fork by [intel-van](https://github.com/intel-van)
